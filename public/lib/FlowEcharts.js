...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === 'object' && typeof module === 'object')
    module.exports = factory(require("echarts"), require("CesiumAndEcharts"));
  else if (typeof define === 'function' && define.amd)
    define(["echarts", "CesiumAndEcharts"], factory);
  else if (typeof exports === 'object')
    exports["FlowEcharts"] = factory(require("echarts"), require("CesiumAndEcharts"));
  else
    root["FlowEcharts"] = factory(root["echarts"], root["CesiumAndEcharts"]);
...
/***/ (function (module, exports, __webpack_require__) {
      ...
      var __WEBPACK_AMD_DEFINE_RESULT__; !(__WEBPACK_AMD_DEFINE_RESULT__ = (function (require) {
        ...
        var CesiumAndEcharts = __webpack_require__(4)
        ...
        GLMapCoordSys.prototype.dataToPoint = function (data) {
          var maxReadRadians = CesiumAndEcharts.Math.toRadians(80)
          var undefinePosition = [99999, 99999]
          var position = CesiumAndEcharts.Cartesian3.fromDegrees(data[0], data[1]);
          if (!position) {
          ...
          if (scene.mode === CesiumAndEcharts.SceneMode.SCENE3D) {
            if (CesiumAndEcharts.Cartesian3.angleBetween(scene.camera.position, position) > maxReadRadians) {
              return false
            }
          }
