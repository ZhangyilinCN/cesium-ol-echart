...
export default {
  mounted() {
    // 1.1.1 创建地球
    var earth = new XE.Earth(this.$refs.cesiumContainer, {
      contextOptions: {
        webgl: {
          // alpha: true,
          // depth: true,
    ...
    //   imageryProvider: CesiumAndEcharts.createTileMapServiceImageryProvider({
    //     url: CesiumAndEcharts.buildModuleUrl("Assets/Textures/NaturalEarthII"),
    //   }),
    //   baseLayerPicker: false,
    //   geocoder: false,
    //   // sceneMode: CesiumAndEcharts.SceneMode.COLUMBUS_VIEW,
    //   creditContainer: "cesium-logo",
    // });

    viewer.extend(CesiumAndEcharts.viewerCesiumNavigationMixin, {});
